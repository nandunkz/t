...
# Mod by shigeno for Adding OCS Panel
# 
# ==================================================
...
commonname=flasshindo.com
email=nandunkz@gmail.com
...
echo 'echo -e "Script mod by Nandunkz"' >> .bashrc
...
chown -R www-data:www-data /home/vps/public_html
chmod -R g+rw /home/vps/public_html service php-fpm restart
service php-fpm restart
service nginx restart

apt-get -y install zip unzip
cd /home/vps/public_html
wget https://github.com/shigeno143/OCSPanelCentos6/raw/master/ShigenoOCSTemplate.zip
